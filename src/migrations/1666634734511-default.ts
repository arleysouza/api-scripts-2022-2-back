...
export class default1666634734511 implements MigrationInterface {
    name = 'default1666634734511'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "grupos" ADD CONSTRAINT "FK_978f13b44883aefdcc1101f0463" FOREIGN KEY ("idcolaborador") REFERENCES "colaboradores"("idcolaborador") ON DELETE CASCADE ON UPDATE CASCADE`);
    }
